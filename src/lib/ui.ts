...
export const focusRing =
  "focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[rgba(184,245,66,0.55)]";
...
export const panelH2 =
  "mb-3 text-[11px] font-bold tracking-[0.3em] text-dim uppercase";

/** Option row inside the sidebar (dashed divider between rows) */
export const trow =
  "flex items-center gap-2 border-t border-dashed border-line py-2.25 text-[13px] first:border-t-0 first:pt-0.5";
...
export const vlist =
  "grid list-none gap-[3px] p-0 [&>li]:before:text-acid [&>li]:before:content-['▸_']";
